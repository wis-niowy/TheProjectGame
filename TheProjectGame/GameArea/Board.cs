...
namespace TheProjectGame.GameArea
{
    public class Board
    {
        ...
        public int PieceAreaHeight { get { return pieceAreaHeight; } }
        public int GoalAreaHeight { get { return goalAreaHeight; } }
        public int BoardHeight { get { return pieceAreaHeight + 2 * goalAreaHeight; } }
